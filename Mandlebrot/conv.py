...
X_standard_train=X_standard_train.reshape(len(X_standard_train),28,28,1)
X_standard_test=X_standard_test.reshape(len(X_standard_test),28,28,1)
X_mandle_train=X_mandle_train.reshape(len(X_mandle_train),28,28,1)
X_mandle_test=X_mandle_test.reshape(len(X_mandle_test),28,28,1)
